import { OPEN_CART, CLOSE_CART, ADD_CART_ITEM, DELETE_CART_ITEM, INCREASE_CART_ITEM, DECREASE_CART_ITEM, ADD_RESTAURANTS, ADD_SEARCH_NAME, SELECT_CUISINE, ORDER, CART_OPENING_ANIMATION, CART_CLOSING_ANIMATION, INVOICE_MODAL } from '../constants';
